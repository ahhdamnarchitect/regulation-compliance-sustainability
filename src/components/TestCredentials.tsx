...
export const TestCredentials = () => {
  ...
  return (
    <Card className="border-border shadow-lg">
      <CardHeader>
        <CardTitle className="text-xl text-primary">Test Credentials</CardTitle>
        ...
        {credentials.map((cred, index) => (
          <div key={index} className="border border-border rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <div>
                <h3 className="font-semibold text-foreground">{cred.type}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
              <div>
                ...
                <div className="flex items-center gap-2">
                  <code className="flex-1 bg-muted/80 px-2 py-1 rounded text-sm">
                    {cred.email}
                  </code>
                  <Button
                    size="sm"
            ...
            <div>
              <label className="text-sm text-foreground/60">Features</label>
