  ...
  return (
    <div className="min-h-screen page-gradient flex flex-col">
      ...
      <div className="flex-1 container mx-auto px-4 py-8 flex items-center justify-center">
        <Card className="w-full max-w-md bg-navy-800 border border-navy-600">
          ...
          <CardContent className="space-y-4">
            {!recoveryChecked || authLoading ? (
              <p className="text-slate-200 text-sm text-center">Loading...</p>
            ) : showInvalid ? (
              <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <Label htmlFor="new-password" className="text-slate-200 font-medium">New password</Label>
                ...
                <div>
                  <Label htmlFor="confirm-password" className="text-slate-200 font-medium">Confirm password</Label>
                  <div className="relative">
                    <Input
                      id="confirm-password"
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full border-navy-600 text-slate-200"
                  disabled={submitting}
                  onClick={async () => {
                    setRecoveryPending(false);
                    await logout();
