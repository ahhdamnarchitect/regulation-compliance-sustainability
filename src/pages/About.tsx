  ...
  return (
    <div className="min-h-screen page-gradient flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 max-w-3xl">
        <h1 className="text-3xl font-bold text-neon-cyan mb-6">About MSRD</h1>
        ...
        <div className="space-y-6 text-slate-200/90 text-sm">
          ...
          <h2 className="text-xl font-semibold text-neon-cyan mt-8 mb-2">Our Mission</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-neon-cyan mt-8 mb-2">Our Vision</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-neon-cyan mt-8 mb-2">Who We Serve</h2>
          <p>
            MSRD is built for:
          </p>
          <ol className="list-decimal list-inside space-y-2 ml-2">
          ...
          <h2 className="text-xl font-semibold text-neon-cyan mt-8 mb-2">Why We're Different</h2>
          <ol className="list-decimal list-inside space-y-3 ml-2">
            <li>
              <strong className="text-slate-200">Structured Intelligence</strong>
              <br />
              MSRD does not simply provide regulatory updates. We organize and structure information to make it usable.
            </li>
            <li>
              <strong className="text-slate-200">Accessibility</strong>
              <br />
            ...
            <li>
              <strong className="text-slate-200">Usability First</strong>
              <br />
            ...
            <li>
              <strong className="text-slate-200">Forward-Looking Infrastructure</strong>
              <br />
          ...
          <h2 className="text-xl font-semibold text-neon-cyan mt-8 mb-2">Our Commitment</h2>
          <p>
