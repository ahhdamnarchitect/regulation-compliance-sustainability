  ...
  return (
    <div className="min-h-screen page-gradient flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 max-w-3xl">
        <h1 className="text-3xl font-bold text-neon-cyan mb-2">Regulatory Disclaimer</h1>
        <p className="text-slate-200/80 text-sm mb-8">Missick Sustainability Regulation Database LLC</p>

        <div className="space-y-4 text-slate-200/90 text-sm">
