      ...
      <div className="min-h-screen page-gradient">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-slate-200 mt-4">Loading regulation details...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="border-navy-600 shadow-lg">
              <CardHeader className="pb-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <CardTitle className="font-title text-2xl font-bold text-slate-200 mb-4">
                      {regulation.title}
                    </CardTitle>
                  ...
                  {user && (
                    <Button
                      ...
                      className={`${isBookmarked ? 'text-yellow-600 border-yellow-300' : 'text-slate-200 border-navy-600'} hover:text-yellow-600`}
                    >
              ...
              <CardContent className="space-y-6">
                ...
                {/* Key Information */}
                <div>
                  <h3 className="text-lg font-semibold text-slate-200 mb-4">Key Information</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      <MapPin className="w-5 h-5 text-neon-cyan" />
                      <div>
                        <p className="text-sm text-slate-200/60">Jurisdiction</p>
                        <p className="font-medium text-slate-200">{regulation.jurisdiction}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-slate-200/60">Sector</p>
                        <p className="font-medium text-slate-200">{regulation.sector}</p>
                      </div>
                    </div>
                    ...
                    {regulation.complianceDeadline && (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm text-slate-200/60">Compliance Deadline</p>
                          <div className="flex items-center gap-2">
                            <p className="font-medium text-slate-200">{formatDate(regulation.complianceDeadline)}</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-slate-200/60">Country</p>
                        <p className="font-medium text-slate-200">{regulation.country}</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {regulation.tags.map((tag: string, index: number) => (
                          <Badge key={index} variant="secondary" className="bg-navy-700 text-slate-200">
                            {tag}
                          </Badge>
                        ))}
                      </div>
                ...
                {regulation.source_url && (
                  <>
                    <Separator className="bg-navy-700" />
                    <div>
                      <h3 className="text-lg font-semibold text-slate-200 mb-3">Official Source</h3>
                      <Button
                        asChild
                        className="bg-neon-cyan hover:bg-neon-cyan/90 text-navy-900 text-white"
                      >
                        <a
          ...
          <div className="space-y-6">
                ...
                {user ? (
                  <>
                    <Button 
                      ...
                      className="w-full bg-neon-cyan hover:bg-neon-cyan/90 text-navy-900 text-white"
                    >
                    ...
                    <Button 
                      variant="outline" 
                      onClick={handleShare}
                      className="w-full border-navy-600"
                    >
                  ...
                  <div className="text-center">
                    ...
                    <Button asChild className="w-full bg-neon-cyan hover:bg-neon-cyan/90 text-navy-900 text-white">
            ...
            <Card className="border-navy-600">
              <CardHeader>
                <CardTitle className="text-lg text-slate-200">Status Definitions</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 text-sm">
                <div>
                  <p className="font-medium text-slate-200 mb-1">Proposed</p>
                  <p className="text-slate-200/80">
                    A regulation that has been formally introduced, but has not been enacted into law.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-slate-200 mb-1">Enacted</p>
                  <p className="text-slate-200/80">
            ...
            <Card className="border-navy-600">
              <CardHeader>
                <CardTitle className="text-lg text-slate-200">Related Information</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3 text-sm">
                  <div>
                    <p className="text-slate-200/60">Framework</p>
                    <p className="font-medium text-slate-200">{regulation.framework}</p>
                  </div>
                  <div>
                    <p className="text-slate-200/60">Last Updated</p>
                    <p className="font-medium text-slate-200">
                      {regulation.updated_at ? formatDate(regulation.updated_at) : 'Not available'}
                    </p>
                  </div>
                  <div>
                    <p className="text-slate-200/60">Date Added</p>
                    <p className="font-medium text-slate-200">
