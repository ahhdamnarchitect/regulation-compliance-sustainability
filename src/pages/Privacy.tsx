  ...
  return (
    <div className="min-h-screen page-gradient flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 max-w-3xl">
        <h1 className="text-3xl font-bold text-neon-cyan mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-slate-200/90 text-sm">
          ...
          <ol className="list-decimal list-inside space-y-3 ml-2">
            <li>
              <strong className="text-slate-200">Information Collected</strong>
              <br />
            ...
            <li>
              <strong className="text-slate-200">Use of Information</strong>
              <br />
            ...
            <li>
              <strong className="text-slate-200">Data Sharing</strong>
              <br />
