  ...
  return (
    <div className="min-h-screen page-gradient flex flex-col">
      ...
      <main className="container mx-auto px-4 py-8 flex-1 max-w-3xl">
        ...
        <p className="text-muted-foreground text-sm mb-8">Missick Sustainability Regulation Database LLC · Effective Date: February 11, 2026</p>
        ...
        <div className="space-y-6 text-foreground/90 text-sm">
          ...
          <ol className="list-decimal list-inside space-y-3 ml-2">
            <li>
              <strong className="text-foreground">Information Collected</strong>
              <br />
            ...
            <li>
              <strong className="text-foreground">Use of Information</strong>
              <br />
            ...
            <li>
              <strong className="text-foreground">User Rights</strong>
              <br />
